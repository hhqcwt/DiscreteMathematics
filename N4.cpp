	...
	for (i = 0; i < MAX; i++)
		for (j = 0; j < MAX; j++) {
			if (i == j) {
				switch (i) {
				case 0:
					inversemx[0][0] = mxa[1][1] * mxa[2][2] - mxa[1][2] * mxa[2][1]; break;
				case 1:
					inversemx[1][1] = mxa[0][0] * mxa[2][2] - mxa[0][2] * mxa[2][0]; break;
				case 2:
					inversemx[2][2] = mxa[0][0] * mxa[1][1] - mxa[0][1] * mxa[1][0];  break;
				}
			}
			else {
